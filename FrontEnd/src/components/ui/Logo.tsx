...
export default function Logo({ size = 'text-2xl', className = '' }: LogoProps) {
  return (
    <div className={`flex items-center font-black uppercase tracking-tighter leading-none overflow-visible pr-2 ${size} ${className}`}>
      ...
      <span className="bg-linear-to-br from-[#e78b7b] via-[#8b4ec7] to-[#395ef3] text-transparent! bg-clip-text">
        Q
      </span>
