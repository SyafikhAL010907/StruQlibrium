  ...
  import { Subject, Material } from "@/types/index";
      ...
      <div className="main-container py-12!">
        ...
        >
          ...
          <h1 className="font-outfit! text-4xl! md:text-6xl! lg:text-7xl! font-black! tracking-tight! mb-4! uppercase! text-slate-900! dark:text-white!">
            BANK SOAL <span className="gradient-text!">KATALOG</span>
          </h1>
          <p className="font-bold! text-base! md:text-lg! max-w-2xl! text-slate-600! dark:text-slate-400!">
            Pilih materi pembelajaran untuk memulai latihan mandiri.
          </p>
        </motion.div>
          ...
          <div className="flex! items-center! gap-3! w-full! md:w-auto!">
            <div className="relative! grow! md:grow-0!">
              <Button 
                ...
                className="w-full! font-black! uppercase! text-[10px]! tracking-widest! h-12! px-6! rounded-xl! border-2! bg-white! dark:bg-slate-950! text-slate-900! dark:text-white! border-slate-200! dark:border-white/10! flex! items-center! justify-center! gap-3! hover:border-violet-600!"
              >
          ...
          {filteredSubjects.map((subject: Subject, i: number) => (
            <motion.div key={subject.id} initial={{ scale: 1.1, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: i * 0.1, duration: 0.4 }}>
              <Card className="premium-card! h-full! flex! flex-col! p-8! group! hover:shadow-2xl! hover:shadow-violet-500/5! transition-all! duration-500!">
                ...
                <Link href={`/BankSoal/materi?subject=${subject.id}`}>
                  <Button variant="primary" className="group/btn! w-full! bg-violet-600! hover:bg-violet-700! text-white!">
                    PILIH MATERI <ChevronRight className="ml-2! w-5! h-5! group-hover/btn:translate-x-1! transition-transform!" />
                  </Button>
                </Link>
              </Card>
            </motion.div>
