  ...
  return (
    <div className="main-container py-12!">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-16!">
        <Link href="/BankSoal" className="inline-flex! items-center! text-slate-500! hover:text-violet-600! transition-colors! font-bold! uppercase! text-xs! tracking-widest! mb-6!">
        ...
        {subjectModules.map((modul: Material, i: number) => (
          ...
          >
            <Card className="premium-card! p-8! h-full! flex! flex-col! group! hover:border-violet-600! transition-all! duration-500!">
              ...
              <Link href={`/BankSoal/materi/modul?subject=${subjectId}&modul=${modul.id}`}>
