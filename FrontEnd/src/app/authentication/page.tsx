...
export default function UnifiedAuthentication() {
  ...
  return (
    <div className="fixed! inset-0! z-50! flex! items-center! justify-center! bg-white! dark:bg-slate-950! overflow-hidden!">
      ...
      >
        <Card className={`premium-card! overflow-hidden! border-2! transition-all! duration-500! ${isAdmin ? 'border-red-500/40! shadow-2xl! shadow-red-500/20!' : 'shadow-2xl! shadow-violet-500/10!'}`}>
          ...
          <div className="p-8! md:p-10! pb-4!">
            ...
            <div className="flex! items-center! justify-between! mb-8!">
              <div>
                <h1 className="font-outfit! text-2xl! md:text-3xl! font-black! tracking-tighter! uppercase! text-slate-900! dark:text-white!">
                  {isLogin ? "MISSION" : "JOIN"} <span className={isAdmin ? 'text-red-500!' : 'gradient-text'}>{isLogin ? "LOGIN" : "PORTAL"}</span>
                </h1>
                <p className="text-xs! font-bold! text-slate-500! mt-1! uppercase! tracking-widest!">
                  {isAdmin ? "ADMINISTRATOR ACCESS ENABLED" : "READY FOR MISSION?"}
                </p>
              </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5!">
               <AnimatePresence mode="wait">
                 {isLogin ? (
                   ...
                   >
                      <input placeholder="Nama Lengkap" className="col-span-2! w-full! p-4! rounded-2xl! font-bold!" />
                      <input placeholder="Username" className="w-full! p-4! rounded-2xl! font-bold!" />
                      <input placeholder="Nama Sekolah" className="w-full! p-4! rounded-2xl! font-bold!" />
                      <input placeholder="Email" className="col-span-2! w-full! p-4! rounded-2xl! font-bold!" />
                      <input type="password" placeholder="Password" className="w-full! p-4! rounded-2xl! font-bold!" />
                      <input type="password" placeholder="Konfirmasi" className="w-full! p-4! rounded-2xl! font-bold!" />
                   </motion.div>
                 )}
               </AnimatePresence>
          ...
          <div className="mt-4! border-t! border-slate-100! dark:border-white/5! bg-slate-50/50! dark:bg-white/2! p-8! flex! items-center! justify-between!">
            ...
            <span className="text-[10px]! font-black! text-slate-400! uppercase! tracking-[0.2em]!">AUTH v3.0</span>
          </div>
        </Card>
      </motion.div>
