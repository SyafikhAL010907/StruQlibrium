  ...
  return (
    <html lang="id" suppressHydrationWarning>
      <body className={`${inter.variable} ${outfit.variable} font-sans antialiased min-h-screen flex flex-col`}>
        ...
        >
          <GameProvider>
            <header className="sticky! top-0! z-40! w-full! bg-white/80! dark:bg-slate-900/80! backdrop-blur-xl! border-b! border-slate-200! dark:border-white/10!">
            ...
            <footer className="bg-white/80! dark:bg-slate-900/80! backdrop-blur-xl! border-t! border-slate-200! dark:border-white/10! p-10! mt-20!">
