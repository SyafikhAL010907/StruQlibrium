    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        {levels.map((level, i) => (
          ...
          >
            <Card className="h-full flex flex-col p-8 group hover:shadow-[0_20px_50px_rgba(139,92,246,0.1)] transition-all duration-500 border-white/5 overflow-hidden relative">
              ...
              <p className="font-bold leading-relaxed mb-10">
                {level.description}
              </p>

              <Link href={`/battlefield/game?level=${level.id}`} className="mt-auto">
                <Button className={`w-full bg-linear-to-r ${level.color} border-none shadow-none`}>
